...
class LocateCam(StateNode):
    ...
    def start(self, event=None):
        ...
        print("Theta:",self.theta*180/np.pi,"Phi",self.phi*180/np.pi, "Camera" +str(self.camera_number)+ " at: ",camera_x, camera_y, self.height)
...
class UpdateGhost(StateMachineProgram):
    ...
    def setup(self):
        ...
        # Code generated by genfsm on Thu Oct 12 11:03:41 2017:
